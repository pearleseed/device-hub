...
ALTER TABLE borrowing_requests AUTO_INCREMENT = 1;
...
-- Insert Equipment
INSERT INTO equipment (name, asset_tag, category, brand, model, status, department_id, purchase_price, purchase_date, specs_json, image_url) VALUES
-- Laptops
...
-- Insert Borrowing Requests
INSERT INTO borrowing_requests (equipment_id, user_id, approved_by, start_date, end_date, reason, status, created_at, updated_at) VALUES
...
INSERT INTO return_requests (borrowing_request_id, return_date, device_condition, notes, created_at) VALUES
