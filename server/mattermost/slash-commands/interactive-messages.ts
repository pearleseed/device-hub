 ...
 */
export function buildCategorySelection(sessionId: string): SlashCommandResponse {
...
export function buildReasonPrompt(
  ...
  const title = action === CommandAction.RENEWAL 
    ...
    actions: [
      createButton(
        ...
        "Cancel",
        {
          sessionId,
          action,
          step: action === CommandAction.BORROW 
...
export function buildBorrowConfirmation(
  ...
  const attachment: MessageAttachment = {
    ...
    fields: [
      ...
      { title: "Duration", value: calculateDuration(startDate, endDate), short: true },
...
export function buildReturnConfirmation(
  ...
  const fields = [
    { title: "Device", value: `${deviceName} (${assetTag})`, short: true },
    { title: "Condition", value: `${conditionInfo?.emoji || ""} ${conditionInfo?.label || condition}`, short: true },
  ];
...
export function buildRenewalConfirmation(
  ...
  const attachment: MessageAttachment = {
    ...
    fields: [
      { title: "Device", value: `${deviceName} (${assetTag})`, short: true },
      { title: "Current End Date", value: formatDate(currentEndDate), short: true },
      { title: "New End Date", value: formatDate(newEndDate), short: true },
      { title: "Renewal Period", value: calculateDuration(currentEndDate, newEndDate), short: true },
      { title: "Reason", value: reason, short: false },
    ],
    actions: [
      createButton(
