...
export type WizardStep = BorrowWizardStep | RenewalWizardStep | ReturnWizardStep;
...
export type WizardSession = BorrowWizardSession | RenewalWizardSession | ReturnWizardSession;
