...
export function createBorrowSession(
  ...
  const session: BorrowWizardSession = {
    ...
    step: deviceId ? BorrowWizardStep.SELECT_TIME : BorrowWizardStep.SELECT_CATEGORY,
    data: {
      deviceId,
      page: 0,
    },
...
export function createRenewalSession(
  ...
  const session: RenewalWizardSession = {
    ...
    step: borrowRequestId ? RenewalWizardStep.SELECT_DURATION : RenewalWizardStep.SELECT_DEVICE,
    data: {
      borrowRequestId,
    },
    createdAt: now,
...
export function createReturnSession(
  ...
  const session: ReturnWizardSession = {
    ...
    step: borrowRequestId ? ReturnWizardStep.SELECT_CONDITION : ReturnWizardStep.SELECT_DEVICE,
    data: {
      borrowRequestId,
    },
    createdAt: now,
