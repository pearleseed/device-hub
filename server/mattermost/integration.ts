...
export async function triggerBorrowNotification(
  ...
  if (!isServiceReady()) {
    console.log("[Mattermost Integration] Service not ready, skipping notification");
    return null;
  }
  ...
  try {
    ...
    if (borrowRequests.length === 0) {
      console.error("[Mattermost Integration] Borrow request not found:", borrowRequestId);
      return null;
    }
    ...
    if (!mattermostUsername) {
      console.error("[Mattermost Integration] Could not get Mattermost username for user:", borrow.user_id);
      return null;
    }
    ...
    if (!device) {
      console.error("[Mattermost Integration] Could not get device info:", borrow.device_id);
      return null;
    }
    ...
    console.error("[Mattermost Integration] Error triggering borrow notification:", error);
    return null;
  }
}
...
export async function triggerReturnNotification(
  ...
  try {
    ...
    if (returnDetails.length === 0) {
      console.error("[Mattermost Integration] Return request not found:", returnRequestId);
      return null;
    }
    ...
    if (!mattermostUsername) {
      console.error("[Mattermost Integration] Could not get Mattermost username for user:", returnReq.user_id);
      return null;
    }
    ...
    if (!device) {
      console.error("[Mattermost Integration] Could not get device info:", returnReq.device_id);
      return null;
    }
    ...
    console.error("[Mattermost Integration] Error triggering return notification:", error);
    return null;
  }
}
...
export async function triggerRenewalNotification(
  ...
  try {
    ...
    if (renewalDetails.length === 0) {
      console.error("[Mattermost Integration] Renewal request not found:", renewalRequestId);
      return null;
    }
    ...
    if (!mattermostUsername) {
      console.error("[Mattermost Integration] Could not get Mattermost username for user:", renewal.user_id);
      return null;
    }
    ...
    if (!device) {
      console.error("[Mattermost Integration] Could not get device info:", renewal.device_id);
      return null;
    }
    ...
    console.error("[Mattermost Integration] Error triggering renewal notification:", error);
    return null;
  }
}
