...
export const MATTERMOST_CONFIG = {
  ...
  wsReconnectInterval: parseInt(process.env.MATTERMOST_WS_RECONNECT_INTERVAL || "5000"),
  wsMaxReconnectAttempts: parseInt(process.env.MATTERMOST_WS_MAX_RECONNECT_ATTEMPTS || "10"),
} as const;
...
export function validateConfig(): { valid: boolean; missing: string[] } {
  const required = [
    ...
    { key: "notificationChannelId", name: "MATTERMOST_NOTIFICATION_CHANNEL_ID" },
  ] as const;
