...
function registerRoutes(): void {
  ...
  // Equipment routes
  addRoute("GET", "/api/equipment", equipmentRoutes.getAll);
  addRoute("GET", "/api/equipment/:id", equipmentRoutes.getById);
  addRoute("POST", "/api/equipment", equipmentRoutes.create);
  addRoute("PUT", "/api/equipment/:id", equipmentRoutes.update);
  addRoute("DELETE", "/api/equipment/:id", equipmentRoutes.delete);
  addRoute(
    "GET",
    "/api/equipment/category/:category",
    equipmentRoutes.getByCategory,
  );
  addRoute("GET", "/api/equipment/status/:status", equipmentRoutes.getByStatus);

  // Borrowing request routes
  addRoute("GET", "/api/borrowing", borrowingRoutes.getAll);
  addRoute("GET", "/api/borrowing/:id", borrowingRoutes.getById);
  addRoute("POST", "/api/borrowing", borrowingRoutes.create);
  addRoute("PATCH", "/api/borrowing/:id/status", borrowingRoutes.updateStatus);
  addRoute("GET", "/api/borrowing/user/:userId", borrowingRoutes.getByUser);
  addRoute("GET", "/api/borrowing/status/:status", borrowingRoutes.getByStatus);
