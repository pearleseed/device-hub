...
import type { RenewalRequest, RenewalStatus, BookingRequest } from "@/lib/mockData";
        ...
        <TableBody>
          {renewals.length === 0 ? (
            ...
            renewals.map((renewal) => {
              ...
              const device = borrowRequest
                ? getDeviceById(borrowRequest.deviceId)
                : null;
                ...
                <TableRow key={renewal.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2 text-sm">
                      <span>{format(new Date(renewal.currentEndDate), "MMM d")}</span>
                  ...
                  <TableCell className="text-right">
                    {renewal.status === "pending" ? (
                      ...
                      <span className="text-xs text-muted-foreground">
                        {renewal.reviewedAt
                          ? format(new Date(renewal.reviewedAt), "MMM d")
                          : "—"}
                      </span>
                    )}
                  </TableCell>
