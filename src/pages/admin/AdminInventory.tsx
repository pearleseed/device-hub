...
const AdminInventory: React.FC = () => {
  ...
  const handleBulkDelete = () => {
    ...
    setDevices(
      devices.filter((d) => !selectedDevices.some((s) => s.id === d.id)),
    );
    setSelectedDevices([]);
      ...
      action: (
        <Button
          ...
          onClick={() => {
            ...
            toast({
              title: "Restored",
              description: `${deletedDevices.length} devices have been restored.`,
            });
          }}
        >
          <Undo2 className="h-4 w-4 mr-1" />
  ...
  const handleExportCSV = () => {
    ...
    toast({
      ...
      description: "Device inventory has been downloaded as CSV.",
    });
  };
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-muted-foreground">
              Manage all devices in your inventory
            </p>
          </div>
