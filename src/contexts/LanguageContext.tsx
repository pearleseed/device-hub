...
const translations: Translations = {
  ...
  'dashboard.activeAccounts': { en: 'Active accounts', ja: 'アクティブアカウント' },
  ...
  'inventory.searchDevices': { en: 'Search devices...', ja: 'デバイスを検索...' },
  'inventory.noDevicesFound': { en: 'No devices found', ja: 'デバイスが見つかりません' },
  'inventory.addFirstDevice': { en: 'Add your first device to get started', ja: '最初のデバイスを追加して始めましょう' },
  'inventory.deviceAdded': { en: 'Device added', ja: 'デバイスを追加しました' },
  'inventory.deviceUpdated': { en: 'Device updated', ja: 'デバイスを更新しました' },
  'inventory.deviceDeleted': { en: 'Device deleted', ja: 'デバイスを削除しました' },
  'inventory.devicesDeleted': { en: 'Devices deleted', ja: 'デバイスを削除しました' },
  'inventory.hasBeenAdded': { en: 'has been added to inventory', ja: 'が在庫に追加されました' },
  'inventory.hasBeenUpdated': { en: 'has been updated', ja: 'が更新されました' },
  'inventory.hasBeenRemoved': { en: 'has been removed', ja: 'が削除されました' },
  'inventory.haveBeenRemoved': { en: 'devices have been removed', ja: '台のデバイスが削除されました' },
  'inventory.haveBeenRestored': { en: 'devices have been restored', ja: '台のデバイスが復元されました' },
  
  // Requests
  'requests.title': { en: 'Request Management', ja: 'リクエスト管理' },
  'requests.subtitle': { en: 'Review and manage device requests', ja: 'デバイスリクエストを確認・管理' },
  'requests.dragHint': { en: 'Drag cards between columns or use keyboard shortcuts', ja: 'カードを列間でドラッグするか、キーボードショートカットを使用' },
  ...
  'requests.statusUpdated': { en: 'Status updated', ja: 'ステータスを更新しました' },
  'requests.movedTo': { en: 'Request moved to', ja: 'リクエストを移動しました：' },
  'requests.kanban': { en: 'Kanban', ja: 'カンバン' },
  'requests.list': { en: 'List', ja: 'リスト' },
  'requests.exportComplete': { en: 'Export complete', ja: 'エクスポート完了' },
  'requests.historyDownloaded': { en: 'Request history has been downloaded as CSV', ja: 'リクエスト履歴がCSVとしてダウンロードされました' },
  ...
  'login.enterCredentials': { en: 'Enter your credentials to access your account', ja: '認証情報を入力してアカウントにアクセス' },
  'login.email': { en: 'Email', ja: 'メールアドレス' },
  'login.password': { en: 'Password', ja: 'パスワード' },
  'login.forgotPassword': { en: 'Forgot password?', ja: 'パスワードをお忘れですか？' },
  'login.rememberMe': { en: 'Remember me for 30 days', ja: '30日間ログイン状態を保持' },
  'login.signIn': { en: 'Sign In', ja: 'サインイン' },
  'login.quickDemoAccess': { en: 'Quick Demo Access:', ja: 'クイックデモアクセス：' },
  ...
  'login.anyPasswordWorks': { en: 'Any password works', ja: 'どのパスワードでも可' },
  'login.manageDevices': { en: "Manage company's devices with ease", ja: '会社のデバイスを簡単に管理' },
  'login.streamlineEquipment': { en: 'Streamline equipment tracking, borrowing, and returns. Keep team equipped with the tools they need.', ja: '機器の追跡、貸出、返却を効率化。チームに必要なツールを提供します。' },
  ...
  'notFound.description': { en: "The page you're looking for doesn't exist or has been moved. Let's get you back on track.", ja: 'お探しのページは存在しないか、移動されました。正しいページへご案内します。' },
  'notFound.goHome': { en: 'Go to', ja: 'へ移動' },
  'notFound.goBack': { en: 'Go Back', ja: '戻る' },
  'notFound.orTryThese': { en: 'Or try one of these:', ja: 'または以下をお試しください：' },
  ...
  'catalog.subtitle': { en: 'Browse and request equipment for your projects.', ja: 'プロジェクト用の機器を閲覧・リクエスト' },
  ...
  'catalog.addedToFavorites': { en: 'Added to favorites', ja: 'お気に入りに追加しました' },
  'catalog.removedFromFavorites': { en: 'Removed from favorites', ja: 'お気に入りから削除しました' },
  'catalog.openingRequestForm': { en: 'Opening request form for', ja: 'リクエストフォームを開いています：' },
  ...
  // Device Detail Modal
  'deviceDetail.requestDevice': { en: 'Request this Device', ja: 'このデバイスをリクエスト' },
  ...
  'deviceDetail.selectDateRange': { en: 'Select Date Range', ja: '日付範囲を選択' },
  'deviceDetail.selectStartEnd': { en: 'Select start and end dates', ja: '開始日と終了日を選択' },
  'deviceDetail.reasonForRequest': { en: 'Reason for Request', ja: 'リクエスト理由' },
  'deviceDetail.reasonPlaceholder': { en: 'Please describe why you need this device...', ja: 'このデバイスが必要な理由を説明してください...' },
  'deviceDetail.reviewRequest': { en: 'Review Request', ja: 'リクエストを確認' },
  'deviceDetail.currentlyAssigned': { en: 'Currently assigned to', ja: '現在の割り当て先' },
  'deviceDetail.specifications': { en: 'Specifications', ja: '仕様' },
  'deviceDetail.operatingSystem': { en: 'Operating System:', ja: 'オペレーティングシステム：' },
  ...
  'deviceDetail.alsoAvailable': { en: 'Also Available', ja: 'その他の利用可能デバイス' },
  'deviceDetail.deviceUnavailable': { en: 'This device is currently', ja: 'このデバイスは現在' },
  'deviceDetail.checkBackLater': { en: 'Check back later or browse other available devices.', ja: '後で確認するか、他の利用可能なデバイスをご覧ください。' },
  'deviceDetail.underMaintenance': { en: 'under maintenance', ja: 'メンテナンス中' },
  'deviceDetail.pleaseSelectDates': { en: 'Please select dates', ja: '日付を選択してください' },
  'deviceDetail.bothDatesRequired': { en: 'Both start and end dates are required.', ja: '開始日と終了日の両方が必要です。' },
  'deviceDetail.pleaseProvideReason': { en: 'Please provide a reason', ja: '理由を入力してください' },
  'deviceDetail.reasonRequired': { en: 'A reason for the request is required.', ja: 'リクエストの理由が必要です。' },
  'deviceDetail.days': { en: 'days', ja: '日間' },
  'deviceDetail.day': { en: 'day', ja: '日' },

  // Confirm Request Modal
  'confirmRequest.title': { en: 'Confirm Your Request', ja: 'リクエストを確認' },
  'confirmRequest.reviewDetails': { en: 'Please review the details before submitting.', ja: '送信前に詳細をご確認ください。' },
  'confirmRequest.loanPeriod': { en: 'Loan Period', ja: '貸出期間' },
  'confirmRequest.reason': { en: 'Reason', ja: '理由' },
  'confirmRequest.submitRequest': { en: 'Submit Request', ja: 'リクエストを送信' },

  // Success Modal
  'success.requestSubmitted': { en: 'Request Submitted!', ja: 'リクエストを送信しました！' },
  'success.requestSentForApproval': { en: 'Your request for', ja: 'リクエストが承認のために送信されました：' },
  'success.hasBeen': { en: 'has been sent for approval.', ja: '' },
  'success.estimatedApproval': { en: 'Estimated approval time', ja: '承認予定時間' },
  'success.businessDays': { en: '1-2 business days', ja: '1〜2営業日' },
  'success.viewMyRequests': { en: 'View My Requests', ja: 'マイリクエストを見る' },
  ...
  'userDashboard.overview': { en: "Here's an overview of your device loans and requests.", ja: 'デバイスの貸出とリクエストの概要です。' },
  'userDashboard.activeLoans': { en: 'Active Loans', ja: 'アクティブな貸出' },
  'userDashboard.devicesCurrentlyBorrowed': { en: 'Devices currently borrowed', ja: '現在借りているデバイス' },
  'userDashboard.pendingRequests': { en: 'Pending Requests', ja: '保留中のリクエスト' },
  'userDashboard.awaitingApproval': { en: 'Awaiting approval', ja: '承認待ち' },
  'userDashboard.quickActions': { en: 'Quick Actions', ja: 'クイックアクション' },
  'userDashboard.browseCatalog': { en: 'Browse Catalog', ja: 'カタログを見る' },
  'userDashboard.currentlyBorrowed': { en: 'Currently Borrowed', ja: '現在借りているもの' },
  'userDashboard.requestHistory': { en: 'Request History', ja: 'リクエスト履歴' },
  'userDashboard.estimatedApproval': { en: 'Estimated approval: 1-2 business days', ja: '承認予定：1〜2営業日' },
  'userDashboard.returnSubmitted': { en: 'Return request submitted', ja: '返却リクエストを送信しました' },
  'userDashboard.adminWillProcess': { en: 'An admin will process your return shortly.', ja: '管理者がまもなく返却を処理します。' },
  ...
  'profile.currentlyBorrowed': { en: 'Currently borrowed', ja: '現在借りているもの' },
  ...
  'profile.recentActivity': { en: 'Recent Activity', ja: '最近のアクティビティ' },
  'profile.latestRequests': { en: 'Your latest device requests', ja: '最新のデバイスリクエスト' },
  'profile.noActivityYet': { en: 'No activity yet', ja: 'まだアクティビティがありません' },
  'profile.browseDevices': { en: 'Browse devices', ja: 'デバイスを見る' },
  'profile.quickActions': { en: 'Quick Actions', ja: 'クイックアクション' },
  'profile.commonTasks': { en: 'Common tasks and shortcuts', ja: '一般的なタスクとショートカット' },
  'profile.browseDeviceCatalog': { en: 'Browse Device Catalog', ja: 'デバイスカタログを見る' },
  'profile.viewMyRequests': { en: 'View My Requests', ja: 'マイリクエストを見る' },
  'profile.notificationSettings': { en: 'Notification Settings', ja: '通知設定' },
  'profile.needHelp': { en: 'Need help?', ja: 'お困りですか？' },
  'profile.contactITSupport': { en: 'Contact IT support for device-related questions.', ja: 'デバイスに関する質問はITサポートにお問い合わせください。' },
  ...
  'notifications.noNotifications': { en: "You don't have any notifications right now. We'll let you know when something arrives.", ja: '現在通知はありません。新しい通知があればお知らせします。' },
  ...
  // Empty States
  'empty.noDevices': { en: 'No devices available', ja: '利用可能なデバイスがありません' },
  'empty.noDevicesDesc': { en: 'Check back later for new devices in the catalog.', ja: '後でカタログの新しいデバイスを確認してください。' },
  'empty.noResults': { en: 'No results found', ja: '結果が見つかりません' },
  'empty.noResultsDesc': { en: 'Try adjusting your search or filter criteria.', ja: '検索条件やフィルターを調整してみてください。' },
  'empty.noFavorites': { en: 'No favorites yet', ja: 'お気に入りがありません' },
  'empty.noFavoritesDesc': { en: 'Click the heart icon on any device to add it to your favorites.', ja: 'デバイスのハートアイコンをクリックしてお気に入りに追加してください。' },
  'empty.noRequests': { en: 'No requests yet', ja: 'リクエストがありません' },
  'empty.noRequestsDesc': { en: 'Browse the catalog to request your first device.', ja: 'カタログを見て最初のデバイスをリクエストしてください。' },
  'empty.noNotifications': { en: 'All caught up!', ja: 'すべて確認済み！' },
  'empty.noNotificationsDesc': { en: "You don't have any notifications right now.", ja: '現在通知はありません。' },
  'empty.noLoans': { en: 'No active loans', ja: 'アクティブな貸出がありません' },
  'empty.noLoansDesc': { en: 'Request a device from the catalog to get started.', ja: 'カタログからデバイスをリクエストして始めましょう。' },
  'empty.comingSoon': { en: 'Coming soon', ja: '近日公開' },
  'empty.comingSoonDesc': { en: 'This feature is currently under development.', ja: 'この機能は現在開発中です。' },
  'empty.getStarted': { en: 'Get Started', ja: '始める' },
  'empty.viewAllDevices': { en: 'View all devices', ja: 'すべてのデバイスを見る' },

  // Add/Edit Device Modal
  'deviceModal.addNewDevice': { en: 'Add New Device', ja: '新しいデバイスを追加' },
  ...
  'deviceModal.specifications': { en: 'Specifications (Optional)', ja: '仕様（オプション）' },
  ...
  'deviceModal.selectCategory': { en: 'Select category', ja: 'カテゴリーを選択' },
  'deviceModal.selectStatus': { en: 'Select status', ja: 'ステータスを選択' },
  'deviceModal.enterDeviceName': { en: 'Enter device name', ja: 'デバイス名を入力' },
  ...
  'deviceModal.enterOS': { en: 'e.g., Windows 11, macOS Sonoma', ja: '例：Windows 11、macOS Sonoma' },
  'deviceModal.enterProcessor': { en: 'e.g., Intel Core i7, M2 Pro', ja: '例：Intel Core i7、M2 Pro' },
  'deviceModal.enterRAM': { en: 'e.g., 16GB, 32GB', ja: '例：16GB、32GB' },
  'deviceModal.enterStorage': { en: 'e.g., 512GB SSD, 1TB SSD', ja: '例：512GB SSD、1TB SSD' },
  ...
  'delete.confirmMessage': { en: 'Are you sure you want to delete', ja: '本当に削除しますか' },
  'delete.confirmMultiple': { en: 'Are you sure you want to delete these', ja: '本当にこれらを削除しますか' },
  'delete.cannotBeUndone': { en: 'This action cannot be undone.', ja: 'この操作は元に戻せません。' },
  ...
  // Error messages
  'error.somethingWentWrong': { en: 'Something went wrong', ja: 'エラーが発生しました' },
  ...
  'error.invalidEmail': { en: 'Invalid email address', ja: '無効なメールアドレス' },
  'error.invalidDate': { en: 'Invalid date', ja: '無効な日付' },
  'error.dateInPast': { en: 'Date cannot be in the past', ja: '過去の日付は指定できません' },
  'error.endBeforeStart': { en: 'End date must be after start date', ja: '終了日は開始日より後である必要があります' },
  ...
  'success.copied': { en: 'Copied to clipboard', ja: 'クリップボードにコピーしました' },
  ...
  'bulk.exportSelected': { en: 'Export selected', ja: '選択項目をエクスポート' },
